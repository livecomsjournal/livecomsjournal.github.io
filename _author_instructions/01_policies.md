...
- Recompile the PDF, and check it into your GitHub repository under the folder `releases/LiveCoMS_Article_ASAP_VX.pdf`, where 'X' is the current article verrsion, along with any final corrections as noted above.
